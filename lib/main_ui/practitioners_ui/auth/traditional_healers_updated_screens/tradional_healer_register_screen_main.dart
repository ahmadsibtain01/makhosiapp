    ...
    return Scaffold(
      body: Column(
        children: [
          ...
          Center(
            child: Image.asset("images/boarding.png", height: 200,width: 250,),
          ),
          SizedBox(
            height: 30,
          ),
          ...
          InkWell(
            ...
            width: 200.0,
              ...
              child: new Center(child: new Text('Begin Onboarding', style: new TextStyle(fontSize: 18.0, color: Colors.white, fontWeight: FontWeight.bold)),),
            ),
          ),
