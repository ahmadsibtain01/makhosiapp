...
class  AppColors
{
  static Color themecolor = Color(0xFF252C4A);
  static Color accentcolor = Color(0xFF78BEBD);
  static Color browncolor = Color(0xFFB36647);
...
class Strings_Text
{
  ...
  static const String signuptag="Créez votre compte avec nous !";
